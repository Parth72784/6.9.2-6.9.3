...
using Registractionandlogininmvc.Models;
namespace Registractionandlogininmvc.Controllers
{
    public class UserController : Controller
    {
        ...
        public ActionResult List()
        {
            ...
            var user = new UserModel(1, "Parth", "pp@p.com", "asdf", "123456789", "1.jpg", "male", 1);
            userlist.Add(user);

            user = new UserModel(1, "Hulk", "ss@s.com", "asdf", "123456789", "2.png", "male", 1);
            userlist.Add(user);
